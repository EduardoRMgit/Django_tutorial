...
class Cobranza(models.Model):
    ...
    - transaccion = many to many transaccion
      tarjetaDebitoNum = CharField(max_length=20, blank=True, null=True)
    - monto = DecimalField(max_digits=30, decimal_places=4, null=True,
      blank=True)
    - comision = DecimalField(max_digits=30, decimal_places=4, null=True
      blank=True)
    - comisionIVA = DecimalField(max_digits=30, decimal_places=4, null=True,
      blank=True)
    - statusCobranza = CharField(max_length=2,choices=STATUS_COBRANZA_CHOICES,
        default=PORCOBRAR)
    """
    PORCOBRAR = 'PC'
    COBRANDO = 'CE'
    ...
    comision = models.DecimalField(
        max_digits=30, decimal_places=4, null=True, blank=True)
    comisionIVA = models.DecimalField(
        max_digits=30, decimal_places=4, null=True, blank=True)
